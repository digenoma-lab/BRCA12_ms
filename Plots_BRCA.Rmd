...
uniq<-variantes %>% distinct(txChange,Gene.refGene, gnomad40_genome_AF)
uniq_sample<-variantes %>% distinct(Tumor_Sample_Barcode)
...
colnames(variantes_suma)<-c("aaChange","afr","amr","ami","asj","eas","sas","fin","mid","nfe","chi")
variantes_suma <- variantes_suma %>% mutate_at(c("afr","amr","ami","asj","eas","sas","fin","mid","nfe","chi"), as.numeric)
...
# save plot 
png(file="Plots_BRCA_files/V2/Fig5_GG.png", width=8, height=3, res=400, unit = "in")
combined_plot
dev.off()
